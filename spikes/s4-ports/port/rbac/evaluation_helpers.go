...
// fathom: the five *Matches functions of
// k8s.io/kubernetes/pkg/apis/rbac/v1/evaluation_helpers.go at tag v1.37.0,
// verbatim (package name aside); CompactString, SortableRuleSlice and the fmt
// import are dropped with the RBAC-write escalation check they serve. The
// matchers are what RuleAllows composes; they already take rbacv1 types and
// have no staging home.
