...
// fathom port of k8s.io/kubernetes/pkg/quota/v1/evaluator/core/services.go at
// tag v1.37.0. The only change: the *api.Service arm of toExternalServiceOrError
// and its converter import are dropped (marked "fathom:").
...
// fathom: the *api.Service conversion arm is gone.
