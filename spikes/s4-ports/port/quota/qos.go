...
// fathom: k8s.io/kubernetes/pkg/apis/core/v1/helper/qos/qos.go at tag v1.37.0,
// verbatim except the two feature-gate reads, which are the constants in
// port/gates. Needed by the quota BestEffort/NotBestEffort scopes.
...
func ComputePodQOS(pod *v1.Pod) v1.PodQOSClass {
	...
	if gates.PodLevelResources &&
		(pod.Spec.Resources != nil && (!gates.PodLevelResourcesFixKubeletQOSClass || resourcehelper.IsPodLevelResourcesSet(pod))) {
